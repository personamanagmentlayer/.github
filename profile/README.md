...
We design **open specifications, protocols, and reference implementations** that make
...
- 💬 **Discussions & design reviews** (architecture, specs, governance)
- 🧪 **Feedback on drafts** (standards are living documents)
- 🧠 **Research insights** (AI safety, governance, systems design)
